...
mFileName = "Pennsylvania_Law_Enforcement_Network.csv"
...
def VisualizeGraph():
    nx.draw(G, center=1581, node_size=300, node_color='blue', with_labels=True)
    plt.savefig('Pennsylvania_Law_Enforcement_Network.png')
    plt.show()
...
def main():
     global counter
     G.add_node(counter, time='1pm', name="DNeX")
     counter = counter + 1
